...
CREATE TABLE IF NOT EXISTS `villagepeople`.`asiakas` (
  ...
  UNIQUE INDEX `asiakas_id_UNIQUE` (`asiakas_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `villagepeople`.`alue` (
  ...
  PRIMARY KEY (`alue_id`),
  UNIQUE INDEX `alue_id_UNIQUE` (`alue_id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `villagepeople`.`mokki` (
  ...
  UNIQUE INDEX `mokki_id_UNIQUE` (`mokki_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `villagepeople`.`varaus` (
  ...
  UNIQUE INDEX `varaus_id_UNIQUE` (`varaus_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `villagepeople`.`lasku` (
  ...
  UNIQUE INDEX `lasku_id_UNIQUE` (`lasku_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `villagepeople`.`palvelu` (
  ...
  UNIQUE INDEX `palvelu_id_UNIQUE` (`palvelu_id` ASC) VISIBLE,
